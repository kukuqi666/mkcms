...
<li class="<?php echo $actor;?>"><a href="/actor.html">演员</a></li>
<li class="<?php echo $zx;?>"><a href="/news.html">资讯</a></li>
<li class="<?php echo $mx;?>"><a href="/star.html">热搜榜</a></li>
<li class="<?php echo $top;?>"><a href="/top.html">影视榜</a></li>
<li class="<?php echo $xjj;?>"><a href="/xjj.html">小姐姐</a></li>
...
echo '<li class="act',$row['id'],'"><a href="',$row['n_url'],'" target="_blank">',$row['n_name'],'</a></li>';
} ?>
</ul>
</li>
</ul>
...
<li><a href="/ucenter/userinfo.html" title="个人设置">个人设置</a></li>
<li class="top-line"><a href="/ucenter/index.html" title="账号中心">账号中心</a></li>
<li class="top-line"><a href="/ucenter/exit.html" title="退出登录">退出登录</a></li>
</ul>
</div>
<?php }else{?>
