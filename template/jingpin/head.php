...
<![endif]-->
<style type="text/css">
body{background-repeat:repeat;background-size:inherit;background-attachment:fixed;background-position:center center;background: url(<?php echo $mkcms_beijing;?>); }
.stui-header__logo .logo {display: block;width: 150px;height: 50px;background: url(<?php echo $mkcms_logo;?>) no-repeat;background-position: 50% 50%;background-size: cover}@media (max-width:767px){body:before{background: url() center 0 no-repeat; background-attachment: fixed;background-size: cover}.stui-header__top{ min-height: 50px}.stui-header__logo{ margin-top: 10px; margin-left: 10px}.layui-layer {width: 90% !important;top: 40px !important;left: 5% !important}}@media (max-width: 1023px){ .stui-header__logo .logo {width: 90px;height: 30px;background: url(<?php echo $mkcms_logo;?>) no-repeat;background-position: 50% 50%;background-size: cover}}
</style>