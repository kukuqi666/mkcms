                      ...
                      <div class="form-group">
                       <div class="nav-btn-tab" style="border:0px;">
                         <ul class="nav nav-pills" id="myTab" >
                           <li role="presentation"  class="active"><a href="kami.html">卡密兑换</a></li>
                           <li role="presentation" style="margin-left:10px;"><a href="mingxi.html">购买VIP</a></li>
                         </ul>
                       </div>    
                      </div>
...
?>
 ...
 <nav class="text-center"><div class="pagination text-center"><ul class="stui-page text-center"><?php echo page_show1($pager[2],$pager[3],$pager[4],2)?></ul></div></nav>
                      </div>  
